    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle>Merkitse ei tapahtumaa / Mark No Transaction</DialogTitle>
                    <DialogDescription>
                        Merkitse määrä, jolla ei ole rahastotapahtumaa (esim. vanha tavara tai lahjoitus).
                        <br />
                        Mark quantity that has no transaction (e.g. legacy item or donation).
                    </DialogDescription>
                </DialogHeader>
                ...
                <DialogFooter>
                    ...
                    <Form method="post" onSubmit={() => onOpenChange(false)}>
                        ...
                        <Button type="submit" disabled={parseInt(quantityToAdd) > maxQuantity || parseInt(quantityToAdd) <= 0}>
                            Vahvista / Confirm
                        </Button>
                    </Form>
                </DialogFooter>

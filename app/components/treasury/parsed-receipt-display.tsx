			...
			<CardContent className="space-y-4">
				{!hasStructuredData && (
					<div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 text-yellow-800 dark:text-yellow-200 rounded-lg">
						<p className="text-sm">
							{t(
								"treasury.receipts.no_ai_parsing",
								"AI parsing is not configured. Only raw text extraction is available. Configure OpenRouter API key in settings to enable structured data extraction.",
							)}
						</p>
					</div>
				)}

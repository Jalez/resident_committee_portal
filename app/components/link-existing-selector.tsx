 ...
 */
export function purchasesToLinkableItems(
	purchases: Purchase[],
): LinkableItem[] {
...
export function receiptsToLinkableItems(
	receiptsByYear: {
		year: string;
...
export function minutesToLinkableItems(
	minutes: { id: string; name: string; year: string; url?: string }[],
): LinkableItem[] {

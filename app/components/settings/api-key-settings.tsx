    ...
    useEffect(() => {
        if (fetcher.data) {
            if ("success" in fetcher.data && fetcher.data.success) {
                ...
                toast.error(fetcher.data.error || t("common.status.error"), { id: "api-key-settings-error" });
            }
        }
        if (deleteFetcher.data) {
            if ("success" in deleteFetcher.data && deleteFetcher.data.success) {
                toast.success(t("common.actions.deleted"), { id: "api-key-delete-success" });
            } else if ("error" in deleteFetcher.data) {
                toast.error(deleteFetcher.data.error || t("common.status.error"), { id: "api-key-delete-error" });
            }
        }

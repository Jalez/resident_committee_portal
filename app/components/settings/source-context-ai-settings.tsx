		...
		<Form method="post" className="space-y-6">
			...
			>
				<div className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
					...
					<p>
						{t(
							"settings.source_context_ai.info_2",
					...
					<p>
						{t(
							"settings.source_context_ai.info_3",
					...
					<div className="pt-2">
						...
						<ul className="list-disc list-inside mt-1 space-y-1 ml-2">
							<li>
								{t(
									"settings.source_context_ai.cat_inventory",
									"Inventory - Items for resale",
								)}
							</li>
							<li>
								{t(
									"settings.source_context_ai.cat_office",
									"Office Supplies - Paper, pens, etc.",
								)}
							</li>
							<li>
								{t(
									"settings.source_context_ai.cat_travel",
									"Travel - Transportation, accommodation",
								)}
							</li>
							<li>
								{t(
									"settings.source_context_ai.cat_food",
									"Food - Meals, catering",
								)}
							</li>
							<li>
								{t(
									"settings.source_context_ai.cat_equipment",
									"Equipment - Tools, furniture",
								)}
							</li>
							<li>
								{t(
									"settings.source_context_ai.cat_marketing",
									"Marketing - Advertising, promotional",
								)}
							</li>
							<li>
								{t(
									"settings.source_context_ai.cat_software",
									"Software - Licenses, subscriptions",
								)}
							</li>
							<li>
								{t(
									"settings.source_context_ai.cat_utilities",
									"Utilities - Electricity, internet, phone",
								)}
							</li>
							<li>
								{t(
									"settings.source_context_ai.cat_rent",
									"Rent - Facility costs",
								)}
							</li>
							<li>
								{t(
									"settings.source_context_ai.cat_other",

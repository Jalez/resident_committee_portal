...
interface NewsAiSettingsProps {
	newsModel: string;
	hasApiKey: boolean;
	models: OpenRouterModel[];
}

export function NewsAiSettings({
	newsModel,
	hasApiKey,
	models,
}: NewsAiSettingsProps) {
	...
	return (
		<Card className={!hasApiKey ? "opacity-50 pointer-events-none" : ""}>
			<CardHeader>
				...
				<CardDescription>{t("settings.news.ai_model_desc")}</CardDescription>
			</CardHeader>
			<CardContent>
						...
						<>
							...
							<div className="space-y-2">
								...
								<Select value={model} onValueChange={setModel}>
									<SelectTrigger>
										<SelectValue
											placeholder={t("settings.news.select_model_placeholder")}
										/>
									</SelectTrigger>

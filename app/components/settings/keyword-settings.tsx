    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <KeywordSettingsCard
                ...
                additionalKeywordsTitle={t("settings.reimbursements.additional_approval")}
            ...
            <KeywordSettingsCard
                ...
                additionalKeywordsTitle={t("settings.reimbursements.additional_rejection")}
                description={t("settings.reimbursements.keywords_desc")}
        ...
        <Card>
            ...
            <CardContent className="space-y-4">
                <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        {customKeywords.map((keyword) => (
                            <Badge key={`custom-${keyword}`} className="bg-green-100 text-green-800 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400 border-green-200 dark:border-green-800">
                                {keyword}
                            </Badge>
                        ))}
                    </div>
                ...
                <fetcher.Form method="post" className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="approval-keywords">
                            {additionalKeywordsTitle}
                        </Label>
                        <Input

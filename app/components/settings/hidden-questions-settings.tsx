...
export function HiddenQuestionsSettings({
    ...
    }, [allQuestions.length, questionsFetcher.state, questionsFetcher.data, questionsFetcher]);
    ...
    useEffect(() => {
        if (formFetcher.data) {
            if ("error" in formFetcher.data) {
                ...
                toast.success(formFetcher.data.message, { id: "hidden-questions-success" });
            }
        }
    }, [formFetcher.data]);
                    ...
                    {isLoadingQuestions ? (
                        ...
                        <>
                            ...
                            <p className="text-xs text-muted-foreground">
                                ...
                                {availableQuestions.length !== 1 ? "s" : ""} found across all sheets
                            </p>
                        </>
                        ...
                        <p className="text-sm text-muted-foreground">
                            No analytics sheets found. Questions will appear here once you have
                            sheets in your analytics folder.
                        </p>
                    )}

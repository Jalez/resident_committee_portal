...
export function PermissionsTable({
    ...
    useEffect(() => {
        if (fetcher.data?.success) {
            toast.success("Oikeudet päivitetty / Permissions updated", { id: "permissions-update-success" });
    ...
    const allPermissions: PermissionRow[] = useMemo(() => {
        ...
        for (const [category, perms] of Object.entries(permissionsByCategory)) {
            // @ts-ignore - iterating typed object
            ...
            <div className="p-6 space-y-4">
                ...
                <div className="flex justify-end pt-4 border-t border-gray-200 dark:border-gray-700">
                    <fetcher.Form method="post">
                        ...
                        <Button type="submit" disabled={fetcher.state !== "idle" || !hasChanges}>
                            {fetcher.state === "idle"

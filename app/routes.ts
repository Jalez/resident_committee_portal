...
export default [
	...
	route("minutes/:minuteId", "routes/minutes.$minuteId.tsx"),
	route("minutes/:minuteId/edit", "routes/minutes.$minuteId.edit.tsx"),
	route("news", "routes/news.tsx"),

	route("news/:newsId", "routes/news.$newsId.tsx"),
	route("news/:newsId/edit", "routes/news.$newsId.edit.tsx"),
	route("faq", "routes/faq.tsx"),

	route("faq/:faqId", "routes/faq.$faqId.tsx"),
	...
	route("api/receipts/:receiptId/delete", "routes/api.receipts.$receiptId.delete.tsx"),
	...
	route("api/receipts/:receiptId/update", "routes/api.receipts.$receiptId.update.tsx"),
	...
	route("api/inventory/:itemId/update", "routes/api.inventory.$itemId.update.tsx"),
	...
	route("api/entities/smart-autofill", "routes/api.entities.smart-autofill.tsx"),
	route("api/relationship/analyze", "routes/api.relationship.analyze.ts"),
	route("api/transactions/:transactionId/delete", "routes/api.transactions.$transactionId.delete.tsx"),
	route("api/transactions/:transactionId/update", "routes/api.transactions.$transactionId.update.tsx"),
	route("api/budgets/:budgetId/delete", "routes/api.budgets.$budgetId.delete.tsx"),
	route("api/budgets/:budgetId/update", "routes/api.budgets.$budgetId.update.tsx"),
	route("api/reimbursements/:reimbursementId/delete", "routes/api.reimbursements.$reimbursementId.delete.tsx"),
	route("api/reimbursements/:reimbursementId/update", "routes/api.reimbursements.$reimbursementId.update.tsx"),
	route("api/news/:newsId/delete", "routes/api.news.$newsId.delete.tsx"),
	route("api/news/:newsId/update", "routes/api.news.$newsId.update.tsx"),
	route("api/minutes/:minuteId/delete", "routes/api.minutes.$minuteId.delete.tsx"),
	route("api/minutes/:minuteId/update", "routes/api.minutes.$minuteId.update.tsx"),
	route("api/faq/:faqId/delete", "routes/api.faq.$faqId.delete.tsx"),
	route("api/faq/:faqId/update", "routes/api.faq.$faqId.update.tsx"),

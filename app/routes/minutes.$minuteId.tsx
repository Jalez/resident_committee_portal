...
import type { Route } from "./+types/minutes.$minuteId";
...
export default function MinuteView({ loaderData }: Route.ComponentProps) {
    ...
    const canUpdate = rootData?.user?.permissions?.some(p => p === "minutes:update" || p === "*");
                            ...
                            {minute.fileUrl && (
                                <TreasuryField label={t("minutes.file", "File")}>
                                    ...
                                    >
                                        ...
                                        {minute.fileKey?.split("/").pop() || t("minutes.view_file", "View File")}
                                    </a>
                                </TreasuryField>
                            )}
                        </div>

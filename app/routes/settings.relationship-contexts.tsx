...
import type { Route } from "./+types/settings.relationship-contexts";
...
export default function SettingsRelationshipContext({ loaderData }: Route.ComponentProps) {
	...
	return (
		<PageWrapper>
			<PageHeader
				primary={t("settings.source.context", { lng: systemLanguages.primary, defaultValue: "Source Contexts" })}
				secondary={t("settings.source.context_desc", {
					lng: systemLanguages.secondary ?? systemLanguages.primary,
					defaultValue: "Configure AI-powered auto-categorization for transactions created from receipts."
				})}
			/>

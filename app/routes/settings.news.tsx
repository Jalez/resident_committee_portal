...
export default function SettingsNews({ loaderData }: Route.ComponentProps) {
	const { hasApiKey, newsModel: serverModel, models, systemLanguages } = loaderData;
	...
	return (
		<PageWrapper>
			<SplitLayout
				header={{
					primary: t("settings.news.title", { lng: systemLanguages.primary }),
					secondary: t("settings.news.title", { lng: systemLanguages.secondary ?? systemLanguages.primary }),
				}}
			>

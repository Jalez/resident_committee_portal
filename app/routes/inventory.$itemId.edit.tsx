        ...
        <PageWrapper>
            <div className="w-full max-w-2xl mx-auto px-4">
                <div className="mb-8">
                    ...
                    <p className="text-lg text-gray-500">{t("inventory.form.subtitle_edit")}</p>
                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder={t("inventory.form.example", { example: "Kahvinkeitin" })}
                                />
                            </div>
                            <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder={t("inventory.form.example", { example: "Kerhohuone" })}
                                />
                            </div>
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder={t("inventory.form.example", { example: "Keittiö" })}
                                />
                            </div>
                        </div>

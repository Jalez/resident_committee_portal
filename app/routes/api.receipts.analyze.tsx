...
export async function action({ request }: ActionFunctionArgs) {
	...
	try {
		...
		console.log("[Analyze Receipt] Starting OCR extraction for file:", file.name, "type:", file.type, "size:", file.size);
		...
		console.log("[Analyze Receipt] OCR result:", rawText ? `${rawText.substring(0, 100)}...` : "null");

		if (!rawText) {
			console.error("[Analyze Receipt] Failed to extract text from file:", file.name);
			const errorDetails = file.type === "application/pdf"

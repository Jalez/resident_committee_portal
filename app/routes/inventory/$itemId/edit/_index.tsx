...
export default function EditInventoryItem({
	...
	const handleAutofillSuggestions = (
		...
		if (suggestions.purchasedAt != null)
			setPurchasedAt(String(suggestions.purchasedAt));
	};
		...
		<PageWrapper>
			<div className="w-full max-w-2xl mx-auto px-4 pb-12">
				...
				>
					...
					<TreasuryDetailCard title={t("inventory.details", "Item Details")}>
						<div className="grid gap-4">
							...
							<TreasuryField
								mode="edit"
								label={t("inventory.form.purchased_at_label")}
								name="purchasedAt"
								type="date"
								value={purchasedAt}
					...
					<TreasuryFormActions
						onCancel={() => navigate(returnUrl || "/inventory")}
					/>
				</Form>
			</div>
		</PageWrapper>

...
export function getEnvStatus(): EnvStatus {
            ...
            variables: [
                {
                    ...
                    helpText: "Local: postgres://user:password@localhost:5432/portal | Neon: postgres://user:password@ep-xxx.region.neon.tech/database?sslmode=require",
                },
                {
                    ...
                    helpText: "Optional. Defaults to 'postgres' in development, 'neon' in production.",
                },
            ],
            ...
            variables: [
                {
                    ...
                    helpText: "Create OAuth 2.0 credentials in Google Cloud Console → APIs & Services → Credentials",
                },
                {
            ...
            variables: [
                {
                    ...
                    helpLink: "https://console.cloud.google.com/apis/credentials",
                    helpText: "Enable Calendar API and Drive API in Google Cloud Console.",
                },
                {
                    ...
                    helpText: "The calendar ID from Google Calendar (e.g., your-org@gmail.com).",
                },
                {
                    ...
                    helpText: "The folder ID from the URL: drive.google.com/drive/folders/{ID}",
                },
            ],
            isFullyConfigured: false,
            configuredCount: 0,
            ...
            variables: [
                {
                    ...
                    helpText: "Create a service account and share your Drive folders with this email.",
                },
                {
                    ...
                    helpText: "From the service account JSON file. Replace newlines with \\n",
                },
            ],
            isFullyConfigured: false,
            configuredCount: 0,
            ...
            variables: [
                {
                    ...
                    helpText: "Create at resend.com/api-keys. Use 'Full Access' for inbound email support.",
                },
                {
                    name: "SENDER_EMAIL",
                    ...
                    helpText: "Must be verified in Resend, or use 'onboarding@resend.dev' for testing.",
                },
                {
            ...
            variables: [
                {
                    ...
                    helpText: "Your Resend receiving address (e.g., anything@your-id.resend.app).",
                },
                {
                    ...
                    helpText: "From Resend dashboard webhook settings (starts with 'whsec_').",
                },
            ],
            isFullyConfigured: false,
            configuredCount: 0,
            ...
            variables: [
                {
                    ...
                    helpText: "Shown in page titles and header. Defaults to 'Resident Committee'.",
                },
                {
    ...
    for (const category of categories) {
        ...
        category.isFullyConfigured = category.configuredCount === category.totalCount;
